...
mod tests {
    ...
    use super::{IDS, contains};

    #[test]
    fn official_list_is_complete_unique_and_exact() {
        assert_eq!(IDS.len(), 74);
        assert_eq!(IDS.iter().copied().collect::<HashSet<_>>().len(), 74);
        assert!(IDS.iter().all(|id| contains(id)));
        for invalid in [
            "",
            "{00A15C55-8517-42AA-B614-E9B94910E393",
            "{00A15C55-8517-42AA-B614-E9B94910E393}extra",
            "00A15C55-8517-42AA-B614-E9B94910E393",
        ] {
