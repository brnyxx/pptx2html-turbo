...
DECKS = tuple(
    "patterns picture-bullets table-styles actions rtl-text handout-master extensions bibliography additional-characteristics custom-xml thumbnail theme-override control-persistence content-part slide-synchronization notes-comments reflection-3d media timing-transitions charts fallback-domains".split()
)
REQUIRED_IDS = set(
    ...
    content-part embedded-control-persistence
