...
DECKS = tuple(
    "patterns picture-bullets table-styles actions rtl-text handout-master extensions bibliography additional-characteristics custom-xml thumbnail notes-comments reflection-3d media timing-transitions charts fallback-domains".split()
)
REQUIRED_IDS = set(
    ...
    action-table-frame action-group rtl-text handout-master extensions bibliography additional-characteristics custom-xml thumbnail
