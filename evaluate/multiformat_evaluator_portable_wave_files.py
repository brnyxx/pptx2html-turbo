...
PORTABLE_WAVE_ENGINE_FILES = (
    ...
    "evaluate/multiformat_portable_native_contract.py",
...
PORTABLE_WAVE_TEST_FILES = (
    "evaluate/tests/multiformat_candidate_runtime_lock_fixture.py",
    "evaluate/tests/multiformat_json_mutation_fixture.py",
    "evaluate/tests/multiformat_portable_capture_fixture.py",
    "evaluate/tests/multiformat_portable_lock_fixture.py",
    "evaluate/tests/multiformat_outer_lock_fixture.py",
    "evaluate/tests/multiformat_portable_lock_materializer_fixture.py",
    ...
    "evaluate/tests/test_multiformat_candidate_artifacts.py",
    ...
    "evaluate/tests/test_materialize_multiformat_candidate_runtime_locks_cli.py",
