...
PDF_CANONICALIZER_VERSION: Final = "1"
PDF_DELIMITERS: Final = b"\x00\t\n\x0c\r ()<>[]{}/%"
_TRAILER_KEYS: Final = frozenset(
    {b"Root", b"Info", b"Encrypt", b"Prev", b"XRefStm", b"ID", b"DocChecksum", b"Size"}
)
PDF_XREF_STREAM_KEYS: Final = _TRAILER_KEYS | frozenset(
...
def pdf_trailer_identity(
    ...
    fields = {
        token.name: value[token.value_start :]
        for token in pdf_unique_name_tokens(value, _TRAILER_KEYS, "trailer-structure")
    }
