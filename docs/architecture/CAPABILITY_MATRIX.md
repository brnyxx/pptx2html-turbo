...
| Effects and 3D | `fallback` | `rendered` | `fallback` | Chunk 2 | Reflection has a bounded deterministic browser approximation with explicit provenance; scene3d, sp3d, and effectDag retain typed known fields and source-ordered raw metadata, without claiming Office lighting/material fidelity |
