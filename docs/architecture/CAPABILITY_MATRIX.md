...
| Effects and 3D | `fallback` | `rendered` | `fallback` | Chunk 2 | Reflection has a bounded deterministic browser approximation with explicit provenance; scene3d, sp3d, effectDag, and theme effect-style reflections retain context-qualified source-ordered raw metadata, without changing the public ShapeEffects layout or claiming Office lighting/material fidelity |
